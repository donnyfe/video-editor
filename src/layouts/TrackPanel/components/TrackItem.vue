...
const isActive = computed(() => {
	return store.selectedTrack.line === props.lineIndex && store.selectedTrack.index === props.itemIndex
})
...
<template>
	<div class="trackItem absolute text-left text-sm top-0"
		...
		<!-- 操作手柄 -->
		<TrackHandler :is-active="isActive"
			:line-index="lineIndex"
			:item-index="itemIndex" />
		<!-- 容器 -->
		<component :is="componentMap.get(trackItem.type)"
